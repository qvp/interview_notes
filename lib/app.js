...
createApp({
    ...
    setup() {
        ...
        const sortedLinksData = computed(() => {
            return [...linksData.value].sort((a, b) => {
                const countA = totalLinksByCategory.value[a.dir] || 0;
                const countB = totalLinksByCategory.value[b.dir] || 0;
